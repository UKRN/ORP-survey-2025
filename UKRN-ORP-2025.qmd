...
UKRN Working Paper number and date: 08 / `r Sys.Date() |> format("%Y-%m-%d")`
...
* [Cecina Babich Morrow](https://orcid.org/0000-0003-2188-1495): Data curation, Software, and Visualization.
...
**DOI**: [10.5281/zenodo.18711621](https://doi.org/10.5281/zenodo.18711621)
...
All survey materials including survey data, visualisation code, codebook, survey instrument, ethics application and approval, participant information sheet, survey recruitment email, briefing to UKRN Institutional Leads and Open Research Coordinators and Administrators (including sampling strategy), data analysis preregistration, and sample representativeness analysis are available on the [UKRN Sharing Platform](https://oercommons.org/groups/evaluation-design/15346/24199/7499/?&__hub_id=179) and on the dedicated [OSF project space](https://doi.org/10.17605/OSF.IO/K8RTZ). The survey data are also available at the University of Bristol data repository [data.bris](https://data.bris.ac.uk/data/) at <https://doi.org/10.5523/bris.3sd9cppbcp2fd20w7zhi7xk2mw>.
...
The detailed sampling strategy and guidance to partner institutions are available on the [UKRN Sharing Platform](https://oercommons.org/groups/evaluation-design/15346/24199/7499/?&__hub_id=179) and on the dedicated [OSF project space](https://doi.org/10.17605/OSF.IO/K8RTZ).
...
The protocol for the ORP Evaluation Design project, of which the survey reported here is a part, is available at <https://oercommons.org/courses/orp-evaluation-protocol-2?__hub_id=179> and at <https://doi.org/10.17605/OSF.IO/V5T7W>

### Materials and data

Study materials, including the survey instrument, consent forms and information sheets are available at <https://oercommons.org/courseware/lesson/137449?__hub_id=179> and at <https://doi.org/10.17605/OSF.IO/K8RTZ>
